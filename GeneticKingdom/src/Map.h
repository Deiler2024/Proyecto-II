...
public:
    ...
    void handleClick(float mouseX, float mouseY, TileType type);  // *Maneja clic del usuario para cambiar tipo de tile*
    TileType getTileType(int row, int col) const;  // ✅ *Devuelve el tipo del tile en la posición indicada*
